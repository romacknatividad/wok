    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#fff7ed_0%,#ffffff_42%,#f5f5f4_100%)]">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.35fr_0.65fr] lg:items-start">
            ...
            <aside className="rounded-[2rem] border border-stone-200 bg-white/90 p-6 shadow-sm backdrop-blur">
              ...
              <div className="mt-6 space-y-4">
                ...
                <InfoRow icon={PhilippinePeso} label="Salary" value="PHP 120,000 to PHP 180,000 / month" />
                <InfoRow icon={Code2} label="Stack" value="React, TypeScript, APIs, SQL" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-[2rem] border border-orange-200 bg-orange-50/70 p-8">
        ...
        <div className="rounded-[2rem] bg-stone-950 px-8 py-10 text-stone-100">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-center">
            ...
            <div className="rounded-3xl border border-stone-800 bg-stone-900 p-6">
              ...
              <Button asChild size="lg" className="mt-6 w-full rounded-full bg-orange-500 hover:bg-orange-600">
