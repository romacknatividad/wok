...
const companyLogos = [
  { name: 'Northstar Retail', image: '/logos/northstar-retail.svg' },
  { name: 'HarborWorks', image: '/logos/harborworks.svg' },
  { name: 'SummitCare', image: '/logos/summitcare.svg' },
  { name: 'BluePeak Logistics', image: '/logos/bluepeak-logistics.svg' },
  { name: 'BrightLedger', image: '/logos/brightledger.svg' },
  { name: 'Pacific People Group', image: '/logos/pacific-people-group.svg' },
  { name: 'AstraFoods', image: '/logos/astrafoods.svg' },
  { name: 'Crestline Health', image: '/logos/crestline-health.svg' },
  { name: 'Orbit Systems', image: '/logos/orbit-systems.svg' },
  { name: 'Luma Commerce', image: '/logos/luma-commerce.svg' },
  { name: 'Meridian Energy', image: '/logos/meridian-energy.svg' },
  { name: 'Atlas Support', image: '/logos/atlas-support.svg' }
];

const testimonials = [
  {
    image:
      'https://images.pexels.com/photos/7872641/pexels-photo-7872641.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    quote:
  ...
  {
    image:
      'https://images.pexels.com/photos/15403161/pexels-photo-15403161.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    quote:
  ...
  {
    image:
      'https://images.pexels.com/photos/15324080/pexels-photo-15324080.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    quote:
    ...
    <main>
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#f4f9ff_0%,#ffffff_48%,#ffffff_100%)] py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="items-center lg:grid lg:grid-cols-12 lg:gap-10">
            <div className="md:mx-auto md:max-w-2xl sm:text-center lg:col-span-6 lg:mx-0 lg:text-left">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:mx-auto sm:max-w-lg sm:flex-row sm:text-center lg:mx-0 lg:text-left">
                <Button
                  asChild
                  size="lg"
            ...
            <div className="relative mt-12 sm:mx-auto sm:max-w-lg lg:col-span-6 lg:mt-0 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
